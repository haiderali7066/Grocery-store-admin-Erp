...
export const ExpenseSchema = new Schema(
  {
    category: { type: String, required: true }, // e.g., rent, utilities
    amount: { type: Number, required: true },
    description: String,
    date: { type: Date, default: Date.now },
    source: { type: String, enum: ['cash', 'bank', 'easypaisa', 'jazzcash', 'card'], default: 'cash' },
...
export const TransactionSchema = new Schema(
  {
    ...
    referenceModel: { type: String, enum: ['Order', 'POSSale', 'Purchase', 'Investment', 'RefundRequest', 'Expense'] },
    description: String,
    notes: String,
    createdBy: { type: Schema.Types.ObjectId, ref: 'User' },
  },
...
export const InvestmentSchema = new Schema(
  {
    ...
    deductionHistory: [
      { purchase: { type: Schema.Types.ObjectId, ref: 'Purchase' }, amount: Number, deductedAt: Date },
    ],
