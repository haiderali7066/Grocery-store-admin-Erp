          ...
          <DialogContent className="rounded-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button type="submit" className="flex-1 bg-primary rounded-full">
                  Add Expense
                </Button>
                <Button
                  type="button"
      ...
      <Card className="p-6 bg-gradient-to-br from-red-50 to-orange-50 border-0">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h2 className="text-3xl font-bold text-red-600">Rs. {totalExpenses.toLocaleString()}</h2>
          </div>
            ...
            {expenses.map((expense) => (
              <div key={expense._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="flex items-center gap-4">
                  <p className="font-bold text-red-600">Rs. {expense.amount.toLocaleString()}</p>
                  <button
