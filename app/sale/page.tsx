...
import {
  Zap, Clock, ShoppingCart, Flame, AlertCircle,
  ArrowRight, Package, Check,
} from "lucide-react";
    ...
    <div className="flex flex-col items-center gap-2">
      <div className="relative w-[72px] h-[72px] md:w-24 md:h-24 lg:w-28 lg:h-28">
        <div className="absolute inset-x-0 top-0 h-1/2 bg-white rounded-t-xl flex items-end justify-center overflow-hidden shadow-[inset_0_-1px_0_rgba(0,0,0,0.08)]">
          <span className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 leading-none mb-px" style={{ fontFamily: "'Georgia', serif" }}>
            {display}
          </span>
        </div>
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gray-100 rounded-b-xl flex items-start justify-center overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.2)]">
          <span className="text-3xl md:text-4xl lg:text-5xl font-black text-gray-700 leading-none mt-px" style={{ fontFamily: "'Georgia', serif" }}>
            {display}
          </span>
        </div>
          ...
          <div className="space-y-5">
            {Array.from({ length: 2 }).map((_, i) => (
              <div
                ...
                style={{ height: 420, animationDelay: `${i * 80}ms` }}
              />
            ))}
          </div>
        )}
